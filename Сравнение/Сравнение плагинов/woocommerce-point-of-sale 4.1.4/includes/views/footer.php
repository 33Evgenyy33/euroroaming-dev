...
// don't load directly
    ...
    <div class="md-modal md-dynamicmodal <?php echo $full_keypad == 'yes' && $instant_quantity == 'yes' ? 'full_keypad' : ''; ?>"
        ...
        <div class="md-content">
            ...
            <div>
                ...
                <a class="button" href="#reset" id="reset_selected_variation"><?php _e('Reset Variation', 'wc_point_of_sale'); ?></a>
                <div class="clear"></div>
                <ul id="selected-variation-data">
                    <li class="variation-price-sku clearfix"><span class="selected-variation-sku"></span><span
                                class="selected-variation-price"></span></li>
                    <?php
                    $show_stock = get_option('wc_pos_show_stock');
                    if ($show_stock == 'yes') { ?>
                        <li class="variation-stock clearfix"><span class="selected-variation-stock"></span></li>
                    <?php } ?>
                </ul>
                <div class="clear"></div>
    ...
    <?php if ($instant_quantity == 'yes') { ?>
        <div class="md-modal md-dynamicmodal md-message md-close-by-overlay <?php echo $full_keypad == 'yes' ? 'full_keypad' : ''; ?>"
             id="modal-qt-product">
            <div class="md-content">
