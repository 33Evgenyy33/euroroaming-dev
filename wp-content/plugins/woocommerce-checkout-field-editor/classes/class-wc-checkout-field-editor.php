	...
	function welcome() {
		...
		<div id="message" class="woocommerce-message wc-connect updated">
			<div class="squeezer">
				...
				<p class="submit"><a class="button-primary" href="http://docs.woothemes.com/document/checkout-field-editor"><?php _e( 'Documentation', 'woocommerce-checkout-field-editor' ); ?></a> <a class="skip button-primary" href="<?php echo esc_url( add_query_arg( 'dismiss_welcome', true ) ); ?>"><?php _e( 'Dismiss', 'woocommerce-checkout-field-editor' ); ?></a></p>
			</div>
		</div>
		<?php
	}
