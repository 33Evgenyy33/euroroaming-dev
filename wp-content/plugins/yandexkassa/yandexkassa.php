...
define("YAMONEY_VERSION", '2.3.4.1');
...
function yandexMoney_submenu_page_callback() {
    ...
    <div class="wrap">
        ...
        <form method="post" action="options.php">
            ...
            <p>Shop ID, scid, shopPassword можно посмотреть в <a href='https://money.yandex.ru/my' target='_blank'>личном кабинете</a> после подключения Яндекс.Кассы.</p>
            <table class="form-table">
                <tr valign="top">
