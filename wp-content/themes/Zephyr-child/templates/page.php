			...
			while ( have_posts() ) {
                ...
                if ($pagename == "questions"){
                    if ( function_exists('yoast_breadcrumb') ) {
                        echo '<style>#breadcrumbs{text-align:center;padding:30px 0 0 0;margin-bottom:0;}.l-section-h.i-cf{padding-top: 12px;}i.fa.fa-chevron-right{color: #599bd1!important;}</style>';
